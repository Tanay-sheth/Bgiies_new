...
export default async function Home() {
  ...
  const role = session?.role; // "A", "B", or "C"
        ...
        <div className="min-h-screen flex flex-col justify-center items-center text-center px-10 py-20">
          ...
          <div className="flex flex-wrap justify-center items-start gap-20">
            ...
            <div className="flex items-center gap-4 max-w-[260px]">
              ...
              <p className="text-gray-700">Connect startups with mentors, investors, and business service providers</p>
            </div>
            ...
            <div className="flex items-center gap-4 max-w-[260px]">
              ...
              <p className="text-gray-700">Give startups visibility on their products with industry giants and partners</p>
            </div>
            ...
            <div className="flex items-center gap-4 max-w-[260px]">
              ...
              <p className="text-gray-700">Facilitate fundraising support for selected startups</p>
            </div>
